...
function createContext (bot, { log, on, registerCleanup } = {}) {
  ...
  const ctx = {
    ...
    ensurePathfinder () {
      ...
      if (!pkg) { if (log?.warn) log.warn('pathfinder missing') ; return false }
      pathfinderPkg = pkg
      return true
    },
    get pathfinder () {
